...
class KernelTrafficLight(object):
    ...
    该内核子类用于就所有交通灯相关组件与模拟器进行交互。具体来说，此类包含以下方法：
    ...
    * Interacting with the simulator: This consisting specifying the states of
      ...
      与模拟器交互：这包括指定特定交通灯在给定时间步长的状态。 这可以通过调用以下方法来完成：
    ...
    * State acquisition: This methods contains several methods for acquiring
      ...
      状态获取：此方法包含几种从特定交通信号灯获取状态信息的方法。
      例如，如果您想获取带有红绿灯的节点的状态（“r”、“g”等），可以通过调用：
    ...
    该类中的所有方法都是抽象的，必须由单独的模拟器的子车辆内核填写。
    """
